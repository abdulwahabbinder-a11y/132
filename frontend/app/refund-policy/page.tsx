  ...
  return (
    <LegalPageLayout title="Refund Policy" lastUpdated="June 16, 2025">
      ...
      <section>
        ...
        <p>Email <a href={`mailto:${SITE.email}`} className="text-violet-400 hover:underline">{SITE.email}</a> with your account email, payment date, and reason. We respond within 2 business days. Approved refunds are processed within 5–10 business days to your original payment method.</p>
      </section>
    </LegalPageLayout>
  );
}
